...
The **Foundation and Master Data modules** are implemented:
...
- Doctor and physical-practice relational data model
- Doctor-to-practice associations without a forced primary location
- Referral snapshots and visit-history storage
- Authoritative two-file import using the current Doctor Spreadsheet and TMS
- Searchable Doctors and Practices views in Streamlit
...
The TMS remains authoritative for routing, referral rank, cadence, due status, routability, and exclusion rules. The current Doctor Spreadsheet refreshes factual doctor/practice/contact information, referral counts, and last-visit dates. A doctor can be associated with multiple physical practices; each physical address is stored once.
