...
from pages.master_data import render_master_data_page
...
tab_master, tab_upload, tab_plan, tab_history, tab_rules = st.tabs(["Master Data", "Upload", "Plan Date Range", "Upload History", "Rules"])
